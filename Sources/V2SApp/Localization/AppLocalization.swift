...
enum AppLocalization {
    ...
    private static let tables: [String: [String: String]] = [
        ...
        "ar": [
            ...
            "sileroVadUnavailableWithoutOnnx": "‏Silero VAD غير متاح لأن هذا البناء لا يتضمن اعتماد ONNX Runtime.",
            ...
            "failedToStartCaptureFormat": "%@",
            "sileroVadUnavailableFallbackFormat": "‏Silero VAD غير متاح: %@. سيتم الرجوع إلى اكتشاف الصمت المعتمد على ASR.",
